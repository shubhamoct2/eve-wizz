...
import TemplateEvent from "@/app/(on-boarding)/on-boarding/boarding-steps/template-preview/template-event";
...
export default function StepTwoEvent({onClickHandler}) {
...
//      }
    ...
    const eventFields = {...watchEvent, galleryImages: gallery, previewUrl: imgSrc}
    return (
        <>
            <section className="steps-counter h-screen w-full">
                <section className="step-1 flex w-full justify-between">
                            ...
                            >
                                <section className={"w-full"}>
                                    <article className="title mt-8 mb-4">
                                        <label htmllFor="eventCategory" className="form-label">Event Category</label>
                                    </article>
                                    <Controller
                                        name="eventCategory"
                                        control={eventControl}
                                                        ...
                                                        {categories?.map((option) => {
                                                            return (
                                                                <SelectItem key={option.id}
                                                                            value={option?.id?.toString()}>{option?.value}</SelectItem>
                                                            )
                                                        })}
                    ...
                    <section className="w-8/12 px-8">
                        <TemplateEvent event={eventFields}/>
                    </section>
                </section>
            </section>
        </>
