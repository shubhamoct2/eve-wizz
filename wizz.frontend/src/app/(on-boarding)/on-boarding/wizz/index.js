...
const VenueOnboarding = () => {
  ...
  const uploadImg = (file, type) => (
    <>
      {typeof file === 'string' || file instanceof String ? (
        <img key={file} alt={type} className={type === 'logo' ? 'logo-file-image' : 'single-file-image'} src={file} />
      ) : (
        <img
          key={file.name}
          alt={file.name}
        ...
        return (
          <form key={0} onSubmit={venueMainSubmit(onVenueMainSubmit)}>
            <Grid container spacing={5}>
              <Grid item xs={12}>
                <Typography variant='h4' sx={{ textAlign: 'center', fontWeight: 600, color: 'common.black' }}>
                  {steps[0].subtitle}
                </Typography>
                <Box sx={{ paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    {steps[0].title}
                  </Typography>
                </Box>
              </Grid>
              ...
              >
                <Button size='large' variant='outlined' color='secondary' onClick={handleBack} sx={{ mr: 24 }} disabled>
                  Back
                </Button>
        ...
        return (
          <form key={1} onSubmit={venueExtraSubmit(onVenueExtraSubmit)}>
            <Grid container spacing={5}>
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <TextField
                        ...
                        InputProps={{
                          endAdornment: <InputAdornment position='end'>{'.eventwizz.org'}</InputAdornment>
                        }}
                        label='Domain'
                        onChange={onChange}
                        placeholder='e.g.stock-brook'
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 4, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    Add Logo
                  </Typography>
                </Box>
                          ...
                          <Box className='dropzone'>
                            ...
                            {value !== undefined && value !== '' ? (
                              ...
                              >
                                ...
                                >
                                  <HeadingTypography variant='h5'>Click here to upload.</HeadingTypography>
                                </Box>
                              </Box>
                            )}
                          </Box>
              ...
              <Grid
                ...
                sx={{ mt: 18, display: 'flex', justifyContent: 'center', position: 'relative' }}
              >
                <Button size='large' variant='outlined' color='secondary' onClick={handleBack} sx={{ mr: 24 }}>
                  Back
                </Button>
                <Button size='large' type='submit' variant='contained'>
                  Next
              ...
              <Grid item xs={12} sm={12}>
                ...
                <CustomFormControl fullWidth>
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        <InputLabel id='venue-event-category-select-label'>{'Choose a category...'}</InputLabel>
                        <Select
                          value={value}
                          label=''
                  ...
                  {eventMainErrors.event_category && (
                    <FormHelperText sx={{ color: 'error.main' }} id='stepper-linear-third-event-category'>
                          ...
                          <Box className='dropzone'>
                            ...
                            {value ? (
                              ...
                              >
                                ...
                                >
                                  <HeadingTypography sx={{ textAlign: 'center' }} variant='h5'>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <FormControl fullWidth>
                  ...
                  {eventMainErrors.banner_heading && (
                    <FormHelperText sx={{ color: 'error.main' }} id='stepper-linear-third-banner-heading'>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <FormControl fullWidth>
                  ...
                  {eventMainErrors.description && (
                    <FormHelperText sx={{ color: 'error.main' }} id='stepper-linear-third-description'>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <CustomFormControl fullWidth>
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        <InputLabel id='venue-event-type-select-label'>{'Choose a event type...'}</InputLabel>
                        <Select
                          value={value}
                          label=''
      ...
      case 4:
        return (
          <form key={4} onSubmit={eventDetailSubmit(onEventDetailSubmit)}>
            <Grid container spacing={5}>
              <Grid item xs={12}>
                <Typography variant='h4' sx={{ mb: 8, textAlign: 'center', fontWeight: 600, color: 'common.black' }}>
                          ...
                          <>
                            {value.data.map((item, index) => (
                              ...
                              >
                                ...
                                >
                                  <Typography sx={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'common.black' }}>
                                  ...
                                  <Grid container spacing={2}>
                                    <Grid item sm={12} xs={12}>
                                      {index !== 0 ? (
                                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                                          ...
                                          >
                                            <Icon fontSize={32} icon='mdi:close-circle-outline' />
                                          </IconButton>
                                        </Box>
                                      ) : null}
                                    </Grid>
                                    ...
                                    <Grid item sm={12} xs={12}>
                                      ...
                                      >
                                        ...
                                        >
                                          How Many People Are Permitted On Each Table?
                                        </Typography>
                                      </Box>
                                    </Grid>
                                    <Grid item sm={12} xs={12}>
                                      {item.list.map((table_item, table_index) => (
                                        <Grid key={table_index} container spacing={2}>
                                          <Grid item sm={12} xs={12}>
                                    ...
                                    <Grid item sm={12} xs={12}>
                                      ...
                                      >
                                        <Typography
                                          ...
                                          sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}
                                        >
                                          Are They Paying A Deposit Or Full Amount?
                                        </Typography>
                                      </Box>
                                    </Grid>
                                    <Grid item sm={12} xs={12}>
                                      ...
                                      >
                                        ...
                                        <FormControlLabel value={0} control={<Radio />} label='Deposit' />
                                      </RadioGroup>
                                    </Grid>
                                    ...
                                    <Grid item sm={12} xs={12}>
                                      ...
                                      >
                                        <Typography
                                          ...
                                          sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}
                                        >
                                          How Many People Are Permitted On Each Tickets?
                                        </Typography>
                                      </Box>
                                    </Grid>
                                    <Grid item sm={12} xs={12}>
        ...
        return (
          <form key={5} onSubmit={eventPackageSubmit(onEventPackageSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 0, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    Event Package
                  </Typography>
                </Box>
              ...
              <Grid item xs={12} sm={12}>
                <FormControl fullWidth>
                  ...
                  {eventPackageErrors.event_main_heading && (
                    <FormHelperText sx={{ color: 'error.main' }} id='error-venue-event-package-main-heading'>
              ...
              <Grid item xs={12} sm={12}>
                <FormControl fullWidth>
                  ...
                  {eventPackageErrors.event_sub_heading && (
                    <FormHelperText sx={{ color: 'error.main' }} id='error-venue-event-package-sub-heading'>
              ...
              <Grid item xs={12} sm={12}>
                <Box>
                  <Typography variant='h6' sx={{ textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    {'Package Info'}
                  </Typography>
                </Box>
                <FormControl fullWidth>
                      ...
                      <>
                        {value.map((item, index) => (
                          <Grid item key={index} xs={12} sm={12} sx={{ mb: 4 }}>
                            <Grid key={index} container spacing={5} sx={{ alignItems: 'center' }}>
                              <Grid item xs={8} sm={8}>
                                <TextField
              ...
              >
                ...
                <Button size='medium' variant='no-outlined' color='secondary' sx={{ position: 'absolute', right: 0 }}>
                  Skip
                </Button>
              </Grid>
            </Grid>
        ...
        return (
          <form key={7} onSubmit={eventMenuSubmit(onEventMenuSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 2, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    Menu Title
                  </Typography>
                </Box>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <FormControl fullWidth>
                  ...
                  {eventMenuErrors.menu_description && (
                    <FormHelperText sx={{ color: 'error.main' }} id='error-venue-event-menu-description'>
              ...
              <Grid item xs={12} sm={12}>
                <FormControl fullWidth>
                  ...
                  />
                  {eventMenuErrors.menu_list && (
                    <FormHelperText sx={{ my: 4, color: 'error.main' }} id='error-venue-event-menu-list'>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ my: 0, display: 'flex', justifyContent: 'center' }}>
                  <Button size='medium' variant='contained' color='secondary' onClick={() => addMoreMenu()}>
                    Add More Menu
                  </Button>
                </Box>
              </Grid>
        ...
        return (
          <form key={5} onSubmit={extraLandingSubmit(onExtraLandingSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <FormControl fullWidth>
                  ...
                  {extraLandingErrors.section_description && (
                    <FormHelperText sx={{ color: 'error.main' }} id='error-venue-event-section-description'>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ my: 4, display: 'flex', justifyContent: 'center' }}>
                  <Button size='medium' variant='contained' color='secondary' onClick={() => addMorePackageDealList()}>
                    Add More Package
                  </Button>
                </Box>
              </Grid>
            ...
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 0, paddingLeft: 2 }}>
                  <Typography variant='h6' sx={{ mt: 2, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    Background Image
                  </Typography>
                </Box>
                <FormControl fullWidth>
                  ...
                  {extraInfoErrors.background && (
                    <FormHelperText sx={{ my: 2, color: 'error.main' }} id='error-extra-info-background'>
                        ...
                        {value.map((item, index) => (
                          <Grid key={index} container spacing={3} sx={{ alignItems: 'center' }}>
                            ...
                            {extraInfoErrors.extra_info && extraInfoErrors.extra_info[index] && (
                              <FormHelperText sx={{ my: 4, color: 'error.main' }} id='error-extra-info-item-summary'>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ my: 4, display: 'flex', justifyContent: 'center' }}>
                  <Button size='medium' variant='contained' color='secondary' onClick={() => addMoreExtraInfoList()}>
                    Add More Row
                  </Button>
                </Box>
              </Grid>
        ...
        return (
          <form key={10} onSubmit={faqInfoSubmit(onFaqInfoSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ my: 4, display: 'flex', justifyContent: 'center' }}>
                  <Button size='medium' variant='contained' color='secondary' onClick={() => addMoreFaqList()}>
                    Add More Row
                  </Button>
                </Box>
              </Grid>
        ...
        return (
          <form key={11} onSubmit={reminderEmailSubmit(onReminderEmailSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 1, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                ...
                <FormControl fullWidth>
                  ...
                  {reminderEmailErrors.is_configure_reminder_email && (
                    <FormHelperText sx={{ my: 4, color: 'error.main' }} id='error-reminder-email-option'>
              ...
              <Grid item xs={12} sm={12}>
                <Box sx={{ mb: 1, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    How Many Days Before The Event Do You Want To Remind Customers To Pay Their Balance?
                  </Typography>
                </Box>
                <FormControl>
                  <Controller
              ...
              <Grid item xs={12} sm={12}>
                <FormControl fullWidth>
                  ...
                  {paymentSettingErrors.payment_option && (
                    <FormHelperText sx={{ my: 4, color: 'error.main' }} id='error-event-payment-setting-option'>
                        ...
                        <Grid container spacing={5}>
                          ...
                          <Grid item xs={12} sm={12}>
                            <RadioGroup
                              ...
                              sx={{ mb: 2 }}
                            >
                              <FormControlLabel value={1} control={<Radio />} label='Live Key' />
                              <FormControlLabel value={0} control={<Radio />} label='Test Key' />
                            </RadioGroup>
                          </Grid>
                          <Grid item xs={12} sm={6}>
                            <TextField
          ...
          <form key={13} onSubmit={anotherLocationSubmit(onAnotherLocationSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12}>
                ...
                <CustomFormControl fullWidth>
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        <InputLabel id='venue-event-another-category-select-label'>{'Choose a category...'}</InputLabel>
                        <Select
                          value={value}
                          label=''
                        ...
                        {anotherLocationErrors.event_category && (
                          <FormHelperText sx={{ color: 'error.main' }} id='error-venue-another-event-category'>
              ...
              <Grid item xs={12}>
                <Box sx={{ mb: 4, paddingLeft: 2, borderLeft: theme => `3px solid ${theme.palette.common.black}` }}>
                  <Typography variant='h5' sx={{ mt: 8, textAlign: 'left', fontWeight: 600, color: 'common.black' }}>
                    Would You Like To Duplicate The Event You Just Created And Add It To Another Location? Don't Worry
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        <RadioGroup
                          ...
                          sx={{ mb: 2 }}
                        >
                          <FormControlLabel value={1} control={<Radio />} label='Yes, Duplicate It' />
                          <FormControlLabel value={0} control={<Radio />} label="No, I'm Ready To Publish It" />
                        </RadioGroup>
                      </>
                    )}
                  />
    ...
    if (activeStep === steps.length) {
      return (
        <Fragment>
          <Grid container spacing={5}>
            <Grid item xs={12} sm={12}>
              <Typography variant='h5' sx={{ mt: 8, textAlign: 'center', fontWeight: 600, color: 'common.black' }}>
                All Steps For Venue Registration Are Completed!
              </Typography>
              <Typography variant='h6' sx={{ mt: 4, textAlign: 'center', fontWeight: 600, color: 'primary.secondary' }}>
                You Can Publish The Venue Information Now.
              </Typography>
            </Grid>
            <Grid item xs={12} md={12} sx={{ mt: 18, display: 'flex', justifyContent: 'center', position: 'relative' }}>
              <Button size='large' variant='outlined' color='secondary' onClick={handleBack} sx={{ mr: 24 }}>
                Back
              </Button>
